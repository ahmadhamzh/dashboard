  ...
  providers: [
    {
      ...
      useExisting: forwardRef(() => KmSelectComponent),
      multi: true,
    },
    {
...
export class KmSelectComponent extends BaseFormValidator implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.form = this._builder.group({
      [KmSelect.Main]: this._builder.control('', this.validators),
    });
  }
}
